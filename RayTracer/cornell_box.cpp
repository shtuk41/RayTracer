...
hitable *cornell_box()
{
	...
	list[i++] = new translate(new rotate_y(new box(vec3(0,0,0),vec3(162,330,165),white), 15), vec3(265,0,295));
...
hitable *cornell_smoke()
{
	...
	hitable *b2 = new translate(new rotate_y(new box(vec3(0,0,0),vec3(162,330,165),white), 15), vec3(265,0,295));
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	std::ofstream frame;
	frame.open("frame_b2_chapter8_640_480.ppm", std::ios::trunc);
